...
// ax04c.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cax04cApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Cax04cApp::OnAppAbout)
...
Cax04cApp::Cax04cApp()
{
	...
	SetAppID(_T("ax04c.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Cax04cApp

Cax04cApp theApp;


// инициализация Cax04cApp

BOOL Cax04cApp::InitInstance()
{
...
// обработчики сообщений Cax04cApp
...
void Cax04cApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Cax04cApp настройка методов загрузки и сохранения

void Cax04cApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Cax04cApp::LoadCustomState()
{
}

void Cax04cApp::SaveCustomState()
{
}

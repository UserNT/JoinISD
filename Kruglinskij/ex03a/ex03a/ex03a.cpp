...
// ex03a.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cex03aApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Cex03aApp::OnAppAbout)
...
Cex03aApp::Cex03aApp()
{
	...
	SetAppID(_T("ex03a.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Cex03aApp

Cex03aApp theApp;


// инициализация Cex03aApp
...
// обработчики сообщений Cex03aApp
...
void Cex03aApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Cex03aApp настройка методов загрузки и сохранения

void Cex03aApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Cex03aApp::LoadCustomState()
{
}

void Cex03aApp::SaveCustomState()
{
}

...
// ex04a.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cex04aApp, CWinAppEx)
	ON_COMMAND(ID_APP_ABOUT, &Cex04aApp::OnAppAbout)
...
Cex04aApp::Cex04aApp()
{
	...
	SetAppID(_T("ex04a.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект Cex04aApp

Cex04aApp theApp;


// инициализация Cex04aApp

BOOL Cex04aApp::InitInstance()
{
...
// обработчики сообщений Cex04aApp
...
void Cex04aApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}

// Cex04aApp настройка методов загрузки и сохранения

void Cex04aApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void Cex04aApp::LoadCustomState()
{
}

void Cex04aApp::SaveCustomState()
{
}

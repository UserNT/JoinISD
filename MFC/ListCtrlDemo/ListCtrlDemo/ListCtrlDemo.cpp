...
// ListCtrlDemo.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CStudentsApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CStudentsApp

CStudentsApp::CStudentsApp()
{
...
// Единственный объект CStudentsApp

CStudentsApp theApp;


// инициализация CStudentsApp

BOOL CStudentsApp::InitInstance()
{

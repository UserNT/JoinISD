...
BEGIN_MESSAGE_MAP(FrameWnd, CFrameWnd)
	...
	ON_COMMAND(ID_DIALOG, OnMenuRadioButtonDialog)
END_MESSAGE_MAP()
...
afx_msg void FrameWnd::OnMenuRadioButtonDialog(void)
{
	...
	{                               // Выход из диалога по ОК
									...
									//   FrameWnd
		m_PenStyle = Dlg.m_PenStyle;
	}

	CWnd::Invalidate();            // Перерисовываем родительское окно
